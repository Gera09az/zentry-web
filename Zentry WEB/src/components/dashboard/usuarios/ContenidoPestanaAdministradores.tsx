...
interface ContenidoPestanaAdministradoresProps {
  usuarios: Usuario[];
  isLoading: boolean;
...
const ContenidoPestanaAdministradores: React.FC<ContenidoPestanaAdministradoresProps> = ({
  usuarios,
  isLoading,
  onVerDetalles,
  onEliminarUsuario,
...
export default ContenidoPestanaAdministradores; 