                        ...
                        <div className="flex flex-col space-y-2">
                          {(usuario as any).identificacionPath && (
                            <Button
                              ...
                              onClick={() => mostrarDocumento((usuario as any).identificacionPath, "Identificación")}
                            >
                          ...
                          {(usuario as any).comprobantePath && (
                            <Button
                              ...
                              size="sm"
                              className="flex items-center gap-1 h-8"
                              onClick={() => mostrarDocumento((usuario as any).comprobantePath, "Comprobante de domicilio")}
                            >
                              <FileText className="h-3.5 w-3.5 text-green-500" />
                              <span>Comprobante</span>
                            </Button>
                          )}
                          {!((usuario as any).identificacionPath || (usuario as any).comprobantePath) && (
                          ...
                          <p className="text-xs text-muted-foreground mt-1">
                            {((usuario as any).identificacionPath || (usuario as any).comprobantePath) ? 
                              "Haz clic para ver los documentos" : 
                              "Este usuario no ha subido documentos"}
                          </p>
                        </div>
                      </TableCell>
                      <TableCell>
