    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-white to-emerald-50">
        ...
        <div className="max-w-5xl mx-auto px-4 py-6">
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-2xl font-bold text-gray-900">Aviso de Privacidad Integral</h1>
      ...
      <div className="max-w-5xl mx-auto px-4 py-8">
        <div className="space-y-8">
          ...
          <Card className="bg-gradient-to-r from-green-50 to-emerald-50 border-green-200">
            <CardContent className="pt-6">
              <div className="text-center space-y-3">
                <h2 className="text-xl font-semibold text-green-900">Aviso de Privacidad Integral</h2>
          ...
          <Card className="hover:shadow-lg transition-shadow duration-300">
            ...
            <CardContent className="pt-6 space-y-4">
              <p className="text-gray-700 leading-relaxed">
                En cumplimiento con lo establecido por la Ley Federal de Protección de Datos Personales en Posesión de los Particulares (LFPDPPP) y su reforma de 2025, ZENTRY TECH GROUP S. DE R.L. DE C.V. (en adelante "ZENTRY"), pone a su disposición el presente Aviso de Privacidad integral.
              </p>
            </CardContent>
          </Card>
          ...
          {/* Sección 9: Cambios al aviso de privacidad */}
          <Card className="hover:shadow-lg transition-shadow duration-300">
            <CardHeader className="bg-gradient-to-r from-purple-50 to-purple-100 rounded-t-lg">
              <CardTitle className="flex items-center gap-3">
                <div className="p-2 bg-purple-500 rounded-lg">
                ...
                <span className="text-purple-900">9. Cambios al aviso de privacidad</span>
              </CardTitle>
            </CardHeader>
            <CardContent className="pt-6 space-y-4">
              <p className="text-gray-700 leading-relaxed">
                ZENTRY se reserva el derecho de realizar modificaciones o actualizaciones al presente aviso de privacidad cuando sea necesario para atender novedades legislativas, políticas internas o nuevos requerimientos para la prestación de servicios.
              </p>
          ...
          <Card className="hover:shadow-lg transition-shadow duration-300">
            ...
            <CardContent className="pt-6 space-y-4">
              <p className="text-gray-700 leading-relaxed">
                Al proporcionar sus datos personales a ZENTRY, ya sea a través de nuestra aplicación móvil (iOS o Android) o cualquier otro medio, usted reconoce haber leído y entendido los términos del presente Aviso de Privacidad y otorga su consentimiento libre, específico e informado para el tratamiento de sus datos personales conforme a lo aquí establecido.
              </p>
              ...
              <p className="text-gray-700 leading-relaxed">
                Para usuarios de la aplicación móvil, el consentimiento se recabará mediante la aceptación electrónica de este Aviso de Privacidad al momento del registro.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="hover:shadow-lg transition-shadow duration-300">
            ...
            <CardContent className="pt-6 space-y-4">
              <p className="text-gray-700 leading-relaxed">
                Para cualquier duda, aclaración o solicitud relacionada con este Aviso de Privacidad o el tratamiento de sus datos personales, puede contactarnos:
              </p>
