...
exports.checkEmailProvider = exports.createResidentUser = exports.publicRegistration = exports.createSecurityUser = void 0;
...
exports.createSecurityUser = (0, https_1.onCall)(async (request) => {
        ...
        if (residencialDocId) {
            try {
                ...
                if (residentialDoc.exists) {
                    ...
                    residentialInfo = {
                        residencialName: (data === null || data === void 0 ? void 0 : data.nombre) || (data === null || data === void 0 ? void 0 : data.name) || '',
                        street: (data === null || data === void 0 ? void 0 : data.direccion) || (data === null || data === void 0 ? void 0 : data.address) || '', // Intentar obtener la calle
                        calles: (data === null || data === void 0 ? void 0 : data.calles) || [],
                    };
...
exports.publicRegistration = (0, https_1.onRequest)({
    cors: true
    ...
    response.set('Access-Control-Allow-Headers', 'Content-Type, Authorization');
    try {
        const { authMethod, email, fullName, paternalLastName, maternalLastName, residencialId, houseNumber, identificacionUrl, comprobanteUrl } = request.body;
        // Log de datos recibidos
        ...
        try {
            ...
            if (!querySnapshot.empty) {
                ...
                residentialInfo = {
                    ...
                    direccion: (data === null || data === void 0 ? void 0 : data.direccion) || '',
                    calles: (data === null || data === void 0 ? void 0 : data.calles) || []
                };
...
exports.createResidentUser = (0, https_1.onCall)(async (request) => {
    ...
    const { email, password, fullName, paternalLastName, maternalLastName, residencialId, residencialDocId, houseNumber, street, houseId } = request.data;
    // Validaciones
    if (!email || !password || !fullName) {
        logger.error('Faltan campos obligatorios');
        throw new https_1.HttpsError("invalid-argument", "Faltan campos obligatorios: email, password, fullName");
    }
    try {
        ...
        if (residencialDocId) {
            try {
                ...
                if (residentialDoc.exists) {
                    ...
                    residentialInfo = {
                        residencialName: (data === null || data === void 0 ? void 0 : data.nombre) || (data === null || data === void 0 ? void 0 : data.name) || '',
                        defaultStreet: (data === null || data === void 0 ? void 0 : data.direccion) || (data === null || data === void 0 ? void 0 : data.address) || '',
                        calles: (data === null || data === void 0 ? void 0 : data.calles) || [],
                    };
                    logger.info('Información del residencial obtenida:', residentialInfo);
                }
        ...
        throw new https_1.HttpsError("internal", `Error al crear usuario residente: ${error.message}`);
    }
});
exports.checkEmailProvider = functions.https.onRequest(async (req, res) => {
    // Permitir CORS
