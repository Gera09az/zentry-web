...
export default function LoginPage() {
  return (
    <div className="min-h-screen flex flex-col lg:grid lg:grid-cols-2 relative">
      ...
      {/* Panel de Branding/Imagen (Primero en móvil, a la derecha en LG) */}
      <div className="order-1 lg:order-2 lg:col-span-1 flex flex-col items-center justify-center relative overflow-hidden bg-gradient-to-b from-blue-50 via-blue-100/50 to-background dark:from-slate-800 dark:via-slate-900 dark:to-black p-6 sm:p-12">
        <div className="w-full max-w-md xl:max-w-lg space-y-6 sm:space-y-8 text-center lg:text-left">
          ...
          {/* Stats */}
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 p-4 sm:p-6 rounded-xl bg-white/60 dark:bg-slate-800/60 backdrop-blur-md border border-blue-100/30 dark:border-slate-700/50 shadow-lg mt-6 sm:mt-8">
      ...
      {/* Panel de Login (Segundo en móvil, a la izquierda en LG) */}
      <div className="order-2 lg:order-1 lg:col-span-1 flex-1 flex items-center justify-center p-6 sm:p-8">
